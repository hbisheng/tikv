...
fn test_split_not_to_split_existing_tombstone_region() {
    ...
    assert_eq!(r1, 1);
    // Pause snapshots. Peers can be created but they can't apply data.
    ...
    // Unblock peer 2. Split will proceed and replace the existing peer 1003. ******* 此时把 split 给 unleash，应该会创造新的节点。
